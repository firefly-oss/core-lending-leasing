package com.catalis.core.lending.leasing.web.controllers.schedule.v1;

import com.catalis.common.core.filters.FilterRequest;
import com.catalis.common.core.queries.PaginationResponse;
import com.catalis.core.lending.leasing.core.services.schedule.v1.LeaseInstallmentScheduleService;
...
public class LeaseInstallmentScheduleController {
    ...
    public Mono<ResponseEntity<LeaseInstallmentScheduleDTO>> getById(
            @PathVariable Long leasingAgreementId,
            @PathVariable Long leaseInstallmentScheduleId) {
